...
class FrmBuku:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='PENGARANG:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='KATEGORI:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        # Textbox
        ...
        Cbo_kategori.grid(row=3, column=1, padx=5, pady=5)
        # Adding kategori combobox drop down list
        Cbo_kategori['values'] = ('agama','ekonomi','komputer','olahraga','kesehatan')
        ...
        # define columns
        columns = ('id','kodebuku','judul','pengarang','kategori')
    ...
    def onReload(self, event=None):
        ...
        for i, d in enumerate(parsed_data):
            self.tree.insert("", i, text="Item {}".format(i), values=(d["id"],d["kodebuku"],d["judul"],d["pengarang"],d["kategori"]))
